...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
          ...
          <div class=" text-center mx-5">
            <h1 class="m-0 site-logo"><a href="index.html">Anna</a></h1>
          </div>
          ...
          <div class="text-left">
            ...
            <nav class="site-navigation position-relative" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="#portfolio-section" class="nav-link">Resume</a></li>
                <li><a href="#clients-section" class="nav-link">Portfolio</a></li>
    ...
    <div class="site-blocks-cover overlay bg-light" id="home-section">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-12 mt-lg-5 text-left align-self-center text-intro">
            <div class="row">
              <div class="col-lg-6">
                <h1 class="text-black">Anna Guerrero</h1>
                <p class="lead">Data Science and Software <br />
                Engineering
                in NYC</p>
      ...
      <img src="images/face.jpg" alt="Image" class="img-face" data-aos="fade">
        ...
        <div class="row ">
          ...
          <div class="col-md-6 mb-4">
            <div class="service d-flex h-100">
              ...
              <div class="service-about">
                ...
                <p>Pandas, NumPy, Matplotlib, Seaborn, R, SQL, MySQL</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="service d-flex h-100">
              ...
              <div class="service-about">
                <h3>Data Science</h3>
                <p>Machine Learning: Scikit-Learn, Keras, 
                Natural Language Processing: NLTK, Gensim</p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="col-lg-4 order-1 order-lg-2 mb-4 mb-lg-0">
            ...
            <img src="images/face3.jpg" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4 order-2 order-lg-1">
            <p>A former ballerina and choreographer turned data enthusiast, I am interested in using my technical and creative skills to bring ideas to life and to create impact in a meaningful way. </p>
            <p>I am currently a master's student in quantitative methods in the social sciences at Columbia University and a software engineering student at the Flatiron School. I have always been curious of not only the intersection of tech, growth, public policy, and business, but also the ethical dimension and implications of big data. </p>
          </div>
          <div class="col-lg-4 order-3 order-lg-3">
            <p>Consciously keeping a personalist approach when solving problems that happen in the world today is something I believe in. I am mainly motivated towards working to enhance the human experience whether it be in extracting insights from data or building both useful and beautiful tools that ultimately propagate human flourishing. </p>
            <p>My skills in the performing arts have translated into my technical pursuits, where creativity, hard work, and mental strength are equally necessary. Although I am only beginning, I am excited to embark on this new journey, to grow in an ever-evolving craft and learn many things on the way. Thank you for stopping by!</p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-3">
            ...
            <p><span class="d-inline-block d-md-block"><a href="mailto:acg2176@columbia.edu" >acg2176@columbia.edu</a></span></b>New York, USA</p>
          </div>
          ...
          <div class="col-md-3">
            ...
            <a href="https://www.facebook.com/montsie.guerrero" class="social-circle"><span class="icon-facebook"></span></a>&nbsp; &nbsp;
            <a href="https://www.instagram.com/montsierat/" class="social-circle"><span class="icon-instagram"></span></a>&nbsp; &nbsp;
            <a href="https://github.com/acg2176" class="social-circle"><span class="icon-github"></span></a>&nbsp; &nbsp;
            <a href="https://www.linkedin.com/in/annamontserratguerrero/" class="social-circle"><span class="icon-linkedin"></span></a>
          </div>
        </div>
